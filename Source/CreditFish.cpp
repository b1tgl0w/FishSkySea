...
//
    //updateHookPoint();
    //sharedHookedByLine->pull(*hookPoint);
//}
//
...
//{
    ...
    //}
//
    //if( shouldResetVerticalTimes )
    //{
        //timeSinceRandomAboutFaceVertical = 0;
        //shouldResetVerticalTimes = false;
    //}
//}
//
...
//
    ...
    //{
        ...
        //sharedFishOwner->moveVertically(pixelsVerticallThisIteration);
...
//}
//
//void CreditFish::FreeState::collidesWithSeaSnail(boost::shared_ptr<SeaSnail> 
...
//}
//
//void CreditFish::HookedState::collidesWithSeaSnail(boost::shared_ptr<SeaSnail> &
    //seaSnail, const BoundingBox &yourBox)
//{
//}
//
